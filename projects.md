...
##[Coffee Quotes](http://davidsivocha.github.io/coffee-quotes)
**Technologies Used:** *Lumen*

Coffee Quotes is a Lumen application that presents the visitor a quote a day about coffee. The initial list is seeded in the Database and can be easily edited for other sites of similar application

You can see site live by visiting [coffeequotes.co.uk](http://coffeequotes.co.uk).

##[Wordpress Api Plugin](http://davidsivocha.github.io/wordpress-api)
**Technologies Used:** *Wordpress*

This is a simple plugin designed to make integrating with Wordpress's Url re-writing functions a breeze to allow the user to easily create an Api that will have access to the entire of the Wordpress Codebase.
